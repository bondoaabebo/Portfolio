...
const dict = {
  ar: {
    ...
    "about.title": "عنّي",
    "about.text":
      " أنا مطوّرة واجهات أمامية بقدم مواقع سريعة، متجاوبة، وسهلة الاستخدام. بشوف كل مشروع فرصة للتعلّم والإبداع، وأسعى دائما للتطوير لمواكبه أحدث التقنيات في عالم الويب.",
